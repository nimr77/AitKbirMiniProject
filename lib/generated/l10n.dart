...
class S {
  ...
  /// `event price per unit`
  String get eventPricePerUnit {
    return Intl.message(
      'event price per unit',
      name: 'eventPricePerUnit',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Done creating the event`
  String get doneCreatingTheevent {
    return Intl.message(
      'Done creating the event',
      name: 'doneCreatingTheevent',
      desc: '',
      args: [],
    );
  }

  /// `Error while Creating the event,try to change something`
  String get errorWhileCreatingTheevent {
    return Intl.message(
      'Error while Creating the event,try to change something',
      name: 'errorWhileCreatingTheevent',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Are you sure of removing this event`
  String get areYouSureOfRemovingThisevent {
    return Intl.message(
      'Are you sure of removing this event',
      name: 'areYouSureOfRemovingThisevent',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Editing event`
  String get titleUpdateevent {
    return Intl.message(
      'Editing event',
      name: 'titleUpdateevent',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Done editing the event`
  String get doneUpdatingTheevent {
    return Intl.message(
      'Done editing the event',
      name: 'doneUpdatingTheevent',
      desc: '',
      args: [],
    );
  }
